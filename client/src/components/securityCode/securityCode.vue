<template>
	<div class="ofcold-security-code clearfix">
		<div class="ofcold-security-code-wrapper">
			<div class="ofcold-security-code-field" v-for="n in securityCodeLength">
				<input
					maxlength="1"
					autocorrect="off"
					autocomplete="off"
