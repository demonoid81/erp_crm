...
export default {
	...
	computed: {
		...
		shouldBeChecked() {
			...
			if (this.m_checked === undefined) return this.m_checked = typeof this.checked === 'string' ? true : !!this.checked
	...
	mounted() {
		if (this.$vnode.data && !this.$vnode.data.staticClass) this.default_mode = true
